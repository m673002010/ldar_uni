...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"ldar_uni","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
function request(method, path) {
  ...
  var _requestConfig$config = _objectSpread(_objectSpread({}, requestConfig), config),
    _requestConfig$config2 = _requestConfig$config.baseUrl,
    baseUrl = _requestConfig$config2 === void 0 ? '' : _requestConfig$config2,
    _requestConfig$config3 = _requestConfig$config.timeout,
    timeout = _requestConfig$config3 === void 0 ? 0 : _requestConfig$config3,
    _requestConfig$config4 = _requestConfig$config.headers,
    headers = _requestConfig$config4 === void 0 ? {} : _requestConfig$config4;
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      ...
      data: data,
      header: _objectSpread(_objectSpread({}, headers), {}, {
...
var assign = function assign(e) {
  ...
  function i(e, a) {
    for (var _t in a) {
      e[_t] = e[_t] && e[_t].toString() === "[object Object]" ? i(e[_t], a[_t]) : e[_t] = a[_t];
    }
    return e;
  }
...
function calCandleMA(o, t, e, n) {
  ...
  for (var r = 0; r < o.length; r++) {
    ...
    for (var _a = 0, _t2 = n.length; _a < _t2; _a++) {
      if (_a < o[r]) {
        i.data.push(null);
        continue;
      }
      var _e = 0;
      for (var _t3 = 0; _t3 < o[r]; _t3++) {
        _e += n[_a - _t3][1];
      }
      i.data.push(+(_e / o[r]).toFixed(3));
    }
    a.push(i);
  }
  return a;
...
function fixPieSeries(e, a, t) {
  ...
  if (e.length > 0 && e[0].data.constructor.toString().indexOf("Array") > -1) {
    a._pieSeries_ = e;
    var _t4 = e[0].data;
    for (var r = 0; r < _t4.length; r++) {
      _t4[r].formatter = e[0].formatter;
      _t4[r].data = _t4[r].value;
      i.push(_t4[r]);
    }
    a.series = i;
  } else {
...
function getSeriesDataItem(e, i, a) {
  ...
  for (var _t7 = 0; _t7 < o.length; _t7++) {
    ...
    if (_e3.data[_a2] !== null && typeof _e3.data[_a2] !== "undefined" && _e3.show) {
      var _t8 = {};
      _t8.color = _e3.color;
      _t8.type = _e3.type;
      _t8.style = _e3.style;
      _t8.pointShape = _e3.pointShape;
      _t8.disableLegend = _e3.disableLegend;
      _t8.legendShape = _e3.legendShape;
      _t8.name = _e3.name;
      _t8.show = _e3.show;
      _t8.data = _e3.formatter ? _e3.formatter(_e3.data[_a2]) : _e3.data[_a2];
      r.push(_t8);
    }
  }
  return r;
...
function getToolTipData(t, a, i, r, o) {
  ...
  if (r.length > 0) {
    ...
    for (var _t10 = 0; _t10 < l.length; _t10++) {
      if (l[_t10][i]) {
        s = l[_t10][i];
        break;
      }
...
function getCandleToolTipData(o, e, n, l, i, t) {
  ...
  var s = t.color.upFill;
  var h = t.color.downFill;
  var c = [s, s, h, s];
  var d = [];
  e.map(function (t) {
    if (l == 0) {
  ...
  for (var _e5 = 0; _e5 < a.length; _e5++) {
    var _t11 = a[_e5];
    if (typeof _t11[l] !== "undefined" && _t11[l] !== null) {
      x.push(_t11[l]);
    }
  }
...
function findCurrentIndex(o, n, e, t) {
  ...
  if (n && n.length > 0) {
    if (!e.categories) {
      ...
      for (var _t12 = 1; _t12 < e.chartData.xAxisPoints.length; _t12++) {
        r.push(e.chartData.xAxisPoints[_t12] - i);
      }
    ...
    if (isInExactChartArea(o, e, t)) {
      if (!e.categories) {
        var _a3 = Array(n.length);
        for (var _e7 = 0; _e7 < n.length; _e7++) {
          _a3[_e7] = Array(n[_e7].length);
          for (var _t13 = 0; _t13 < n[_e7].length; _t13++) {
            _a3[_e7][_t13] = Math.abs(n[_e7][_t13].x - o.x);
          }
        }
        var _e6 = Array(_a3.length);
        var _i = Array(_a3.length);
        for (var _t14 = 0; _t14 < _a3.length; _t14++) {
          _e6[_t14] = Math.min.apply(null, _a3[_t14]);
          _i[_t14] = _a3[_t14].indexOf(_e6[_t14]);
        }
        var _r = Math.min.apply(null, _e6);
        l.index = [];
        for (var _t15 = 0; _t15 < _e6.length; _t15++) {
          if (_e6[_t15] == _r) {
            l.group.push(_t15);
            l.index.push(_i[_t15]);
          }
        }
      } else {
...
function findLegendIndex(o, t, e) {
  ...
  if (isInExactLegendArea(o, t.area)) {
    var i = t.points;
    var r = -1;
    for (var _t16 = 0, _e8 = i.length; _t16 < _e8; _t16++) {
      var a = i[_t16];
      for (var _e9 = 0; _e9 < a.length; _e9++) {
        r += 1;
        var _t17 = a[_e9]["area"];
        if (_t17 && o.x > _t17[0] - l && o.x < _t17[2] + l && o.y > _t17[1] - l && o.y < _t17[3] + l) {
          n = r;
          break;
        }
      }
...
function calLegendData(l, s, e, t, h) {
  ...
  var d = s.legend.padding * s.pix;
  var x = s.legend.margin * s.pix;
  var f = s.legend.fontSize ? s.legend.fontSize * s.pix : e.fontSize;
  var p = 15 * s.pix;
  var g = 5 * s.pix;
  var u = Math.max(s.legend.lineHeight * s.pix, f);
  if (s.legend.position == "top" || s.legend.position == "bottom") {
    ...
    for (var a = 0; a < l.length; a++) {
      var _t18 = l[a];
      var y = _t18.legendText ? _t18.legendText : _t18.name;
      var _e10 = p + g + measureText(y || "undefined", f, h) + s.legend.itemGap * s.pix;
      if (r + _e10 > s.width - s.area[1] - s.area[3]) {
        i.push(n);
    ...
    if (n.length) {
      ...
      o.push(r - s.legend.itemGap * s.pix);
      c.widthArr = o;
      var _t19 = Math.max.apply(null, o);
      switch (s.legend.float) {
        case "left":
          c.area.start.x = s.area[3];
          c.area.end.x = s.area[3] + _t19 + 2 * d;
          break;
        case "right":
          c.area.start.x = s.width - s.area[1] - _t19 - 2 * d;
          c.area.end.x = s.width - s.area[1];
          break;
        default:
          c.area.start.x = (s.width - _t19) / 2 - d;
          c.area.end.x = (s.width + _t19) / 2 + d;
      }
      c.area.width = _t19 + 2 * d;
      c.area.wholeWidth = _t19 + 2 * d;
    ...
    var _t20 = l.length;
    var _e11 = s.height - s.area[0] - s.area[2] - 2 * x - 2 * d;
    var _a4 = Math.min(Math.floor(_e11 / u), _t20);
    c.area.height = _a4 * u + d * 2;
    c.area.wholeHeight = _a4 * u + d * 2;
    switch (s.legend.float) {
      case "top":
    ...
    var _i2 = _t20 % _a4 === 0 ? _t20 / _a4 : Math.floor(_t20 / _a4 + 1);
    var _r2 = [];
    for (var _e12 = 0; _e12 < _i2; _e12++) {
      var _t21 = l.slice(_e12 * _a4, _e12 * _a4 + _a4);
      _r2.push(_t21);
    }
    c.points = _r2;
    if (_r2.length) {
      for (var _t22 = 0; _t22 < _r2.length; _t22++) {
        var _a5 = _r2[_t22];
        var _i3 = 0;
        for (var _e14 = 0; _e14 < _a5.length; _e14++) {
          var _t23 = p + g + measureText(_a5[_e14].name || "undefined", f, h) + s.legend.itemGap * s.pix;
          if (_t23 > _i3) {
            _i3 = _t23;
          }
        }
        c.widthArr.push(_i3);
        c.heightArr.push(_a5.length * u + d * 2);
      }
      var _e13 = 0;
      for (var _t24 = 0; _t24 < c.widthArr.length; _t24++) {
        _e13 += c.widthArr[_t24];
      }
      c.area.width = _e13 - s.legend.itemGap * s.pix + 2 * d;
...
function calCategoriesData(t, i, e, a, r) {
  ...
  if (i.xAxis.rotateLabel == true) {
    ...
    var _t25 = i.xAxis.marginTop * i.pix * 2 + Math.abs(s * Math.sin(o.angle));
    _t25 = _t25 < n + i.xAxis.marginTop * i.pix * 2 ? _t25 + i.xAxis.marginTop * i.pix * 2 : _t25;
    o.xAxisHeight = _t25;
  }
...
function getXAxisTextList(t, e, h, c) {
  ...
  i = i.filter(function (t) {
    if ((0, _typeof2.default)(t) === "object" && t !== null) {
...
function getRadarDataPoints(r, o, n, a, t) {
  ...
  for (var _e15 = 0; _e15 < a.length; _e15++) {
    _loop(_e15);
  }
  return h;
}
function getPieDataPoints(a, i) {
  ...
  for (var _e16 = 0; _e16 < a.length; _e16++) {
    var _t26 = a[_e16];
    _t26.data = _t26.data === null ? 0 : _t26.data;
    if (o === 0) {
      _t26._proportion_ = 1 / a.length * r;
    } else {
      _t26._proportion_ = _t26.data / o * r;
    }
    _t26._radius_ = i;
  }
  for (var _e17 = 0; _e17 < a.length; _e17++) {
    var _t27 = a[_e17];
    _t27._start_ = n;
    n += 2 * _t27._proportion_ * Math.PI;
  }
  return a;
}
...
function getRoseDataPoints(a, i, r, o) {
  ...
  for (var _e18 = 0; _e18 < a.length; _e18++) {
    var _t28 = a[_e18];
    _t28.data = _t28.data === null ? 0 : _t28.data;
    if (l === 0) {
      _t28._proportion_ = 1 / a.length * n;
      _t28._rose_proportion_ = 1 / a.length * n;
    } else {
      _t28._proportion_ = _t28.data / l * n;
      if (i == "area") {
        _t28._rose_proportion_ = 1 / a.length * n;
      } else {
        _t28._rose_proportion_ = _t28.data / l * n;
      }
    }
    _t28._radius_ = r + x * ((_t28.data - c) / (d - c)) || o;
  }
  for (var _e19 = 0; _e19 < a.length; _e19++) {
    var _t29 = a[_e19];
    _t29._start_ = s;
    s += 2 * _t29._rose_proportion_ * Math.PI;
  }
  return a;
}
...
function getGaugeAxisPoints(e, a, t) {
  ...
  for (var _t30 = 0; _t30 < e.length; _t30++) {
    e[_t30].value = e[_t30].value === null ? 0 : e[_t30].value;
    e[_t30]._startAngle_ = r;
    e[_t30]._endAngle_ = i * e[_t30].value + a;
    if (e[_t30]._endAngle_ >= 2) {
      e[_t30]._endAngle_ = e[_t30]._endAngle_ % 2;
    }
    r = e[_t30]._endAngle_;
  }
  return e;
...
function getGaugeDataPoints(i, r, o) {
  ...
  for (var a = 0; a < i.length; a++) {
    ...
    if (o.pointer.color == "auto") {
      for (var _t31 = 0; _t31 < r.length; _t31++) {
        if (e.data <= r[_t31].value) {
          e.color = r[_t31].color;
          break;
        }
      }
    } else {
...
function getPieTextMaxLength(i, r, o, n) {
  ...
  for (var a = 0; a < i.length; a++) {
    var t = i[a];
    var e = t.formatter ? t.formatter(+t._proportion_.toFixed(2)) : util.toFixed(t._proportion_ * 100) + "%";
    ...
    if (i === null) {
      ...
      if ((0, _typeof2.default)(i) === "object" && i !== null) {
        if (i.constructor.toString().indexOf("Array") > -1) {
          var _t32, _e20, _a6;
          _t32 = [].concat(h.chartData.xAxisData.ranges);
          _e20 = _t32.shift();
          _a6 = _t32.pop();
          o = i[1];
          r.x = h.area[3] + p * (i[0] - _e20) / (_a6 - _e20);
          if (h.type == "bubble") {
            r.r = i[2];
            r.t = i[3];
          }
    ...
    if (i === null) {
      ...
      if (p.animation == "vertical") {
        ...
        if ((0, _typeof2.default)(i) === "object" && i !== null) {
          if (i.constructor.toString().indexOf("Array") > -1) {
            var _t33, _e21, _a7;
            _t33 = [].concat(h.chartData.xAxisData.ranges);
            _e21 = _t33.shift();
            _a7 = _t33.pop();
            o = i[1];
            r.x = h.area[3] + u * (i[0] - _e21) / (_a7 - _e21);
          } else {
            o = i.value;
          }
        }
  ...
  t.forEach(function (i, t) {
    if (i === null) {
      ...
      if ((0, _typeof2.default)(i) === "object" && i !== null) {
        if (i.constructor.toString().indexOf("Array") > -1) {
          var _t34, _e22, _a8;
          _t34 = [].concat(h.chartData.xAxisData.ranges);
          _e22 = _t34.shift();
          _a8 = _t34.pop();
          o = i[1];
          r.x = h.area[3] + f * (i[0] - _e22) / (_a8 - _e22);
        } else {
          o = i.value;
        }
      }
...
function calYAxisData(a, o, e, n) {
  ...
  var s = new Array(t);
  if (t > 0) {
    for (var _e23 = 0; _e23 < t; _e23++) {
      s[_e23] = [];
      for (var _t37 = 0; _t37 < a.length; _t37++) {
        if (a[_t37].index == _e23) {
          s[_e23].push(a[_t37]);
        }
      }
    }
    ...
    var _loop2 = function _loop2(r) {
      var i = o.yAxis.data[r];
      if (o.yAxis.disabled == true) {
        i.disabled = true;
      }
      if (i.type === "categories") {
        if (!i.formatter) {
          i.formatter = function (t, e, a) {
            return t + (i.unit || "");
          };
        }
      ...
      var a = i.fontSize * o.pix || e.fontSize;
      d[r] = {
    ...
    if (o.type === "bar") {
      ...
      if (!o.yAxis.formatter) {
        o.yAxis.formatter = function (t, e, a) {
...
function calTooltipYAxisData(r, t, o, e, a) {
  var n = [].concat(o.chartData.yAxisData.ranges);
  var l = o.height - o.area[0] - o.area[2];
  var s = o.area[0];
  var h = [];
  for (var i = 0; i < n.length; i++) {
    var _t38 = Math.max.apply(this, n[i]);
    var _e24 = Math.min.apply(this, n[i]);
    var _a9 = _t38 - (_t38 - _e24) * (r - s) / l;
    _a9 = o.yAxis.data && o.yAxis.data[i].formatter ? o.yAxis.data[i].formatter(_a9, i, o) : _a9.toFixed(0);
    h.push(String(_a9));
  }
  return h;
}
function calMarkLineData(i, r) {
  var o, n;
  var l = r.height - r.area[0] - r.area[2];
  for (var a = 0; a < i.length; a++) {
    i[a].yAxisIndex = i[a].yAxisIndex ? i[a].yAxisIndex : 0;
    var t = [].concat(r.chartData.yAxisData.ranges[i[a].yAxisIndex]);
    o = t.pop();
    n = t.shift();
    var e = l * (i[a].value - o) / (n - o);
...
function drawPointText(t, o, n, l, s) {
  ...
  t.forEach(function (t, e) {
    if (t !== null) {
      ...
      var i = h[e];
      if ((0, _typeof2.default)(h[e]) === "object" && h[e] !== null) {
...
function drawColumePointText(t, n, l, s, h) {
  ...
  t.forEach(function (t, e) {
    if (t !== null) {
      ...
      var i = c[e];
      if ((0, _typeof2.default)(c[e]) === "object" && c[e] !== null) {
...
function drawGaugeLabel(e, a, i, r, o, n) {
  ...
  var c = t / e.splitLine.splitNumber;
  var d = e.endNumber - e.startNumber;
  var x = d / e.splitLine.splitNumber;
  var l = e.startAngle;
  var s = e.startNumber;
  for (var _t39 = 0; _t39 < e.splitLine.splitNumber + 1; _t39++) {
    var h = {
      x: a * Math.cos(l * Math.PI),
      y: a * Math.sin(l * Math.PI)
    };
    var f = e.formatter ? e.formatter(s, _t39, r) : s;
...
function drawPieText(n, d, x, f, t, l) {
  ...
  for (var c = 0; c < y.length; c++) {
    var _t40 = y[c];
    var e = Math.cos(_t40.arc) * (_t40.radius + p);
    var a = Math.sin(_t40.arc) * (_t40.radius + p);
    var i = Math.cos(_t40.arc) * _t40.radius;
    var r = Math.sin(_t40.arc) * _t40.radius;
    var o = e >= 0 ? e + x.pieChartTextPadding : e - x.pieChartTextPadding;
    var _n = a;
    var _l = measureText(_t40.text, _t40.textSize * d.pix || x.fontSize, f);
    var s = _n;
    if (g && util.isSameXCoordinateArea(g.start, {
      x: o
    })) {
      if (o > 0) {
        s = Math.min(_n, g.start.y);
      } else if (e < 0) {
        s = Math.max(_n, g.start.y);
      } else {
        if (_n > 0) {
          s = Math.max(_n, g.start.y);
        } else {
    ...
    var h = {
      ...
      text: _t40.text,
      color: _t40.color,
      textColor: _t40.textColor,
      textSize: _t40.textSize
    };
    g = avoidCollision(h, g);
    u.push(g);
  }
  for (var _n2 = 0; _n2 < u.length; _n2++) {
    if (y[_n2].labelShow === false) {
      continue;
    }
    var _t41 = u[_n2];
    var _e25 = convertCoordinateOrigin(_t41.lineStart.x, _t41.lineStart.y, l);
    var _a10 = convertCoordinateOrigin(_t41.lineEnd.x, _t41.lineEnd.y, l);
    var _i4 = convertCoordinateOrigin(_t41.start.x, _t41.start.y, l);
    f.setLineWidth(1 * d.pix);
    f.setFontSize(_t41.textSize * d.pix || x.fontSize);
    f.beginPath();
    f.setStrokeStyle(_t41.color);
    f.setFillStyle(_t41.color);
    f.moveTo(_e25.x, _e25.y);
    var _r3 = _t41.start.x < 0 ? _i4.x + _t41.width : _i4.x;
    var _o = _t41.start.x < 0 ? _i4.x - 5 : _i4.x + 5;
    f.quadraticCurveTo(_a10.x, _a10.y, _r3, _i4.y);
    f.moveTo(_e25.x, _e25.y);
    f.stroke();
    f.closePath();
    f.beginPath();
    f.moveTo(_i4.x + _t41.width, _i4.y);
    f.arc(_r3, _i4.y, 2 * d.pix, 0, 2 * Math.PI);
    f.closePath();
    f.fill();
    f.beginPath();
    f.setFontSize(_t41.textSize * d.pix || x.fontSize);
    f.setFillStyle(_t41.textColor || d.fontColor);
    f.fillText(_t41.text, _o, _i4.y + 3);
    f.closePath();
    f.stroke();
    f.closePath();
  }
...
function drawToolTipSplitLine(r, o, n, l) {
  ...
  l.setLineDash([]);
  if (s.xAxisLabel) {
    var _t42 = o.categories[o.tooltip.index];
    l.setFontSize(n.fontSize);
    var e = measureText(_t42, n.fontSize, l);
    var a = r - .5 * e;
    var i = h + 2 * o.pix;
    l.beginPath();
...
function drawMarkLine(h, t, c) {
  ...
  var a = h.area[3];
  var i = h.width - h.area[1];
  var r = calMarkLineData(e.data, h);
  for (var _t43 = 0; _t43 < r.length; _t43++) {
    var s = assign({}, {
      lineColor: "#DE4A42",
      showLabel: false,
      labelFontSize: 13,
    ...
    c.setLineDash([]);
    if (s.showLabel) {
      var _t44 = s.labelFontSize * h.pix;
      var _e26 = s.labelText ? s.labelText : s.value;
      c.setFontSize(_t44);
      var _a11 = measureText(_e26, _t44, c);
      var _i5 = _a11 + s.labelPadding * h.pix * 2;
      var _r4 = s.labelAlign == "left" ? h.area[3] - _i5 : h.width - h.area[1];
      _r4 += s.labelOffsetX;
      var o = s.y - .5 * _t44 - s.labelPadding * h.pix;
      o += s.labelOffsetY;
      var n = _r4 + s.labelPadding * h.pix;
      var l = s.y;
      c.setFillStyle(hexToRgb(s.labelBgColor, s.labelBgOpacity));
      c.setStrokeStyle(s.labelBgColor);
      c.setLineWidth(1 * h.pix);
      c.beginPath();
      c.rect(_r4, o, _i5, _t44 + 2 * s.labelPadding * h.pix);
      c.closePath();
      c.stroke();
      c.fill();
      c.setFontSize(_t44);
      ...
      c.fillText(String(_e26), n, o + _t44 + s.labelPadding * h.pix / 2);
      c.stroke();
      c.setTextAlign("left");
    }
  }
...
function drawToolTipHorizentalLine(x, f, p, t, e) {
  ...
  p.setLineDash([]);
  if (u.yAxisLabel) {
    var l = u.boxPadding * x.pix;
    var s = calTooltipYAxisData(x.tooltip.offset.y, x.series, x, f, t);
    var h = x.chartData.yAxisData.yAxisWidth;
    var c = x.area[3];
    var d = x.width - x.area[1];
    for (var n = 0; n < s.length; n++) {
      p.setFontSize(u.fontSize * x.pix);
      var _t45 = measureText(s[n], u.fontSize * x.pix, p);
      var _e27 = void 0,
        _a12 = void 0,
        _i6 = void 0;
      if (h[n].position == "left") {
        _e27 = c - (_t45 + l * 2) - 2 * x.pix;
        _a12 = Math.max(_e27, _e27 + _t45 + l * 2);
      } else {
        _e27 = d + 2 * x.pix;
        _a12 = Math.max(_e27 + h[n].width, _e27 + _t45 + l * 2);
      }
      _i6 = _a12 - _e27;
      var r = _e27 + (_i6 - _t45) / 2;
      var o = x.tooltip.offset.y;
      p.beginPath();
      ...
      p.setLineWidth(1 * x.pix);
      p.rect(_e27, o - .5 * f.fontSize - l, _i6, f.fontSize + 2 * l);
      p.closePath();
      p.stroke();
      p.fill();
      p.beginPath();
...
function drawColumnDataPoints(T, b, S, w) {
  ...
  T.forEach(function (a, i) {
    ...
    t = e.pop();
    o = e.shift();
    var x = b.height - b.area[0] - b.area[2];
    var f = x * (0 - t) / (o - t);
    var n = b.height - Math.round(f) - b.area[2];
    a.zeroPoints = n;
    var p = a.data;
    switch (D.type) {
      case "group":
        ...
        for (var _t46 = 0; _t46 < r.length; _t46++) {
          var _o2 = r[_t46];
          if (_o2 !== null && _t46 > L && _t46 < F) {
            var l = _o2.x - _o2.width / 2;
            var s = b.height - _o2.y - b.area[2];
            w.beginPath();
            var g = _o2.color || a.color;
            var y = _o2.color || a.color;
            if (D.linearType !== "none") {
              var v = w.createLinearGradient(l, _o2.y, l, n);
            ...
            if (D.barBorderRadius && D.barBorderRadius.length === 4 || D.barBorderCircle === true) {
              var h = l;
              var c = _o2.y > n ? n : _o2.y;
              var d = _o2.width;
              var _s = Math.abs(n - _o2.y);
              ...
              var _D$barBorderRadius = (0, _slicedToArray2.default)(D.barBorderRadius, 4),
                _t47 = _D$barBorderRadius[0],
                _e28 = _D$barBorderRadius[1],
                _a13 = _D$barBorderRadius[2],
                _i7 = _D$barBorderRadius[3];
              var _r5 = Math.min(d / 2, _s / 2);
              _t47 = _t47 > _r5 ? _r5 : _t47;
              _e28 = _e28 > _r5 ? _r5 : _e28;
              _a13 = _a13 > _r5 ? _r5 : _a13;
              _i7 = _i7 > _r5 ? _r5 : _i7;
              _t47 = _t47 < 0 ? 0 : _t47;
              _e28 = _e28 < 0 ? 0 : _e28;
              _a13 = _a13 < 0 ? 0 : _a13;
              _i7 = _i7 < 0 ? 0 : _i7;
              w.arc(h + _t47, c + _t47, _t47, -Math.PI, -Math.PI / 2);
              w.arc(h + d - _e28, c + _e28, _e28, -Math.PI / 2, 0);
              w.arc(h + d - _a13, c + _s - _a13, _a13, 0, Math.PI / 2);
              w.arc(h + _i7, c + _s - _i7, _i7, Math.PI / 2, Math.PI);
            } else {
              w.moveTo(l, _o2.y);
              w.lineTo(l + _o2.width, _o2.y);
              w.lineTo(l + _o2.width, n);
              w.lineTo(l, n);
              w.lineTo(l, _o2.y);
              w.setLineWidth(1);
              w.setStrokeStyle(y);
      ...
      case "stack":
        ...
        for (var _e29 = 0; _e29 < r.length; _e29++) {
          var _t48 = r[_e29];
          if (_t48 !== null && _e29 > L && _e29 < F) {
            w.beginPath();
            var g = _t48.color || a.color;
            var l = _t48.x - _t48.width / 2 + 1;
            var s = b.height - _t48.y - b.area[2];
            var m = b.height - _t48.y0 - b.area[2];
            if (i > 0) {
              s -= m;
            }
            w.setFillStyle(g);
            w.moveTo(l, _t48.y);
            w.fillRect(l, _t48.y, _t48.width, s);
            w.closePath();
            w.fill();
          }
        }
      ...
      case "meter":
        ...
        for (var _t49 = 0; _t49 < r.length; _t49++) {
          var _o3 = r[_t49];
          if (_o3 !== null && _t49 > L && _t49 < F) {
            w.beginPath();
            ...
            if (i == 0) {
              ...
              w.setFillStyle(_o3.color || a.color);
            }
            var l = _o3.x - _o3.width / 2;
            var s = b.height - _o3.y - b.area[2];
            if (D.barBorderRadius && D.barBorderRadius.length === 4 || D.barBorderCircle === true) {
              var _h = l;
              var _c = _o3.y;
              var _d = _o3.width;
              var _s2 = n - _o3.y;
              if (D.barBorderCircle) {
                D.barBorderRadius = [_d / 2, _d / 2, 0, 0];
              }
              var _D$barBorderRadius2 = (0, _slicedToArray2.default)(D.barBorderRadius, 4),
                _t50 = _D$barBorderRadius2[0],
                _e30 = _D$barBorderRadius2[1],
                _a14 = _D$barBorderRadius2[2],
                _i8 = _D$barBorderRadius2[3];
              var _r6 = Math.min(_d / 2, _s2 / 2);
              _t50 = _t50 > _r6 ? _r6 : _t50;
              _e30 = _e30 > _r6 ? _r6 : _e30;
              _a14 = _a14 > _r6 ? _r6 : _a14;
              _i8 = _i8 > _r6 ? _r6 : _i8;
              _t50 = _t50 < 0 ? 0 : _t50;
              _e30 = _e30 < 0 ? 0 : _e30;
              _a14 = _a14 < 0 ? 0 : _a14;
              _i8 = _i8 < 0 ? 0 : _i8;
              w.arc(_h + _t50, _c + _t50, _t50, -Math.PI, -Math.PI / 2);
              w.arc(_h + _d - _e30, _c + _e30, _e30, -Math.PI / 2, 0);
              w.arc(_h + _d - _a14, _c + _s2 - _a14, _a14, 0, Math.PI / 2);
              w.arc(_h + _i8, _c + _s2 - _i8, _i8, Math.PI / 2, Math.PI);
              w.fill();
            } else {
              w.moveTo(l, _o3.y);
              w.lineTo(l + _o3.width, _o3.y);
              w.lineTo(l + _o3.width, n);
              w.lineTo(l, n);
              w.lineTo(l, _o3.y);
              w.fill();
            }
...
function drawMountDataPoints(i, r, o, n) {
  ...
  v = y.pop();
  m = y.shift();
  var T = r.height - r.area[0] - r.area[2];
  var b = T * (0 - v) / (m - v);
  var h = r.height - Math.round(b) - r.area[2];
  var c = getMountDataPoints(i, v, m, p, l, r, s, h, f);
  switch (s.type) {
    case "bar":
      for (var _t51 = 0; _t51 < c.length; _t51++) {
        var _o4 = c[_t51];
        if (_o4 !== null && _t51 > u && _t51 < g) {
          var d = _o4.x - l * s.widthRatio / 2;
          var S = r.height - _o4.y - r.area[2];
          n.beginPath();
          var a = _o4.color || i[_t51].color;
          var w = _o4.color || i[_t51].color;
          if (s.linearType !== "none") {
            var x = n.createLinearGradient(d, _o4.y, d, h);
            if (s.linearType == "opacity") {
              x.addColorStop(0, hexToRgb(a, s.linearOpacity));
              x.addColorStop(1, hexToRgb(a, 1));
            } else {
              x.addColorStop(0, hexToRgb(s.customColor[i[_t51].linearIndex], s.linearOpacity));
              x.addColorStop(s.colorStop, hexToRgb(s.customColor[i[_t51].linearIndex], s.linearOpacity));
              x.addColorStop(1, hexToRgb(a, 1));
            }
            a = x;
          }
          if (s.barBorderRadius && s.barBorderRadius.length === 4 || s.barBorderCircle === true) {
            var A = d;
            var P = _o4.y > h ? h : _o4.y;
            var C = _o4.width;
            var _S = Math.abs(h - _o4.y);
            ...
            var _s$barBorderRadius = (0, _slicedToArray2.default)(s.barBorderRadius, 4),
              _t52 = _s$barBorderRadius[0],
              _e31 = _s$barBorderRadius[1],
              _a15 = _s$barBorderRadius[2],
              _i9 = _s$barBorderRadius[3];
            var _r7 = Math.min(C / 2, _S / 2);
            _t52 = _t52 > _r7 ? _r7 : _t52;
            _e31 = _e31 > _r7 ? _r7 : _e31;
            _a15 = _a15 > _r7 ? _r7 : _a15;
            _i9 = _i9 > _r7 ? _r7 : _i9;
            _t52 = _t52 < 0 ? 0 : _t52;
            _e31 = _e31 < 0 ? 0 : _e31;
            _a15 = _a15 < 0 ? 0 : _a15;
            _i9 = _i9 < 0 ? 0 : _i9;
            n.arc(A + _t52, P + _t52, _t52, -Math.PI, -Math.PI / 2);
            n.arc(A + C - _e31, P + _e31, _e31, -Math.PI / 2, 0);
            n.arc(A + C - _a15, P + _S - _a15, _a15, 0, Math.PI / 2);
            n.arc(A + _i9, P + _S - _i9, _i9, Math.PI / 2, Math.PI);
          } else {
            n.moveTo(d, _o4.y);
            n.lineTo(d + _o4.width, _o4.y);
            n.lineTo(d + _o4.width, h);
            n.lineTo(d, h);
            n.lineTo(d, _o4.y);
          }
          n.setStrokeStyle(w);
    ...
    case "triangle":
      for (var _e32 = 0; _e32 < c.length; _e32++) {
        var _t53 = c[_e32];
        if (_t53 !== null && _e32 > u && _e32 < g) {
          var d = _t53.x - l * s.widthRatio / 2;
          var S = r.height - _t53.y - r.area[2];
          n.beginPath();
          var a = _t53.color || i[_e32].color;
          var w = _t53.color || i[_e32].color;
          if (s.linearType !== "none") {
            var x = n.createLinearGradient(d, _t53.y, d, h);
            if (s.linearType == "opacity") {
              x.addColorStop(0, hexToRgb(a, s.linearOpacity));
              x.addColorStop(1, hexToRgb(a, 1));
            } else {
              x.addColorStop(0, hexToRgb(s.customColor[i[_e32].linearIndex], s.linearOpacity));
              x.addColorStop(s.colorStop, hexToRgb(s.customColor[i[_e32].linearIndex], s.linearOpacity));
              x.addColorStop(1, hexToRgb(a, 1));
            }
            a = x;
          }
      ...
      break;
    case "mount":
      for (var _e33 = 0; _e33 < c.length; _e33++) {
        var _t54 = c[_e33];
        if (_t54 !== null && _e33 > u && _e33 < g) {
          var d = _t54.x - l * s.widthRatio / 2;
          var S = r.height - _t54.y - r.area[2];
          n.beginPath();
          var a = _t54.color || i[_e33].color;
          var w = _t54.color || i[_e33].color;
          if (s.linearType !== "none") {
            var x = n.createLinearGradient(d, _t54.y, d, h);
            if (s.linearType == "opacity") {
              x.addColorStop(0, hexToRgb(a, s.linearOpacity));
              x.addColorStop(1, hexToRgb(a, 1));
            } else {
              x.addColorStop(0, hexToRgb(s.customColor[i[_e33].linearIndex], s.linearOpacity));
              x.addColorStop(s.colorStop, hexToRgb(s.customColor[i[_e33].linearIndex], s.linearOpacity));
              x.addColorStop(1, hexToRgb(a, 1));
            }
            a = x;
          }
          n.moveTo(d, h);
          n.bezierCurveTo(_t54.x - _t54.width / 4, h, _t54.x - _t54.width / 4, _t54.y, _t54.x, _t54.y);
          n.bezierCurveTo(_t54.x + _t54.width / 4, _t54.y, _t54.x + _t54.width / 4, h, d + _t54.width, h);
          n.setStrokeStyle(w);
          n.setFillStyle(a);
          if (s.borderWidth > 0) {
            n.setLineWidth(s.borderWidth * r.pix);
      ...
      break;
    case "sharp":
      for (var _e34 = 0; _e34 < c.length; _e34++) {
        var _t55 = c[_e34];
        if (_t55 !== null && _e34 > u && _e34 < g) {
          var d = _t55.x - l * s.widthRatio / 2;
          var S = r.height - _t55.y - r.area[2];
          n.beginPath();
          var a = _t55.color || i[_e34].color;
          var w = _t55.color || i[_e34].color;
          if (s.linearType !== "none") {
            var x = n.createLinearGradient(d, _t55.y, d, h);
            if (s.linearType == "opacity") {
              x.addColorStop(0, hexToRgb(a, s.linearOpacity));
              x.addColorStop(1, hexToRgb(a, 1));
            } else {
              x.addColorStop(0, hexToRgb(s.customColor[i[_e34].linearIndex], s.linearOpacity));
              x.addColorStop(s.colorStop, hexToRgb(s.customColor[i[_e34].linearIndex], s.linearOpacity));
              x.addColorStop(1, hexToRgb(a, 1));
            }
            a = x;
          }
          n.moveTo(d, h);
          n.quadraticCurveTo(_t55.x - 0, h - S / 4, _t55.x, _t55.y);
          n.quadraticCurveTo(_t55.x + 0, h - S / 4, d + _t55.width, h);
          n.setStrokeStyle(w);
          n.setFillStyle(a);
          if (s.borderWidth > 0) {
            n.setLineWidth(s.borderWidth * r.pix);
  ...
  if (r.dataLabel !== false && f === 1) {
    var _t56, _e35, _a16;
    _t56 = [].concat(r.chartData.yAxisData.ranges[0]);
    _e35 = _t56.pop();
    _a16 = _t56.shift();
    var c = getMountDataPoints(i, _e35, _a16, p, l, r, s, h, f);
...
function drawBarDataPoints(y, v, m, T) {
  ...
  var S = [];
  var w = (v.height - v.area[0] - v.area[2]) / v.categories.length;
  for (var t = 0; t < v.categories.length; t++) {
    ...
    switch (A.type) {
      case "group":
        ...
        for (var _t57 = 0; _t57 < i.length; _t57++) {
          var _o5 = i[_t57];
          if (_o5 !== null && _t57 > C && _t57 < D) {
            var n = v.area[3];
            var r = _o5.y - _o5.width / 2;
            var p = _o5.height;
            T.beginPath();
            var l = _o5.color || a.color;
            var u = _o5.color || a.color;
            if (A.linearType !== "none") {
              var s = T.createLinearGradient(n, _o5.y, _o5.x, _o5.y);
            ...
            if (A.barBorderRadius && A.barBorderRadius.length === 4 || A.barBorderCircle === true) {
              var g = n;
              var h = _o5.width;
              var c = _o5.y - _o5.width / 2;
              var _p = _o5.height;
              if (A.barBorderCircle) {
                A.barBorderRadius = [h / 2, h / 2, 0, 0];
              }
              var _A$barBorderRadius = (0, _slicedToArray2.default)(A.barBorderRadius, 4),
                _t58 = _A$barBorderRadius[0],
                _e36 = _A$barBorderRadius[1],
                _a17 = _A$barBorderRadius[2],
                _i10 = _A$barBorderRadius[3];
              var _r8 = Math.min(h / 2, _p / 2);
              _t58 = _t58 > _r8 ? _r8 : _t58;
              _e36 = _e36 > _r8 ? _r8 : _e36;
              _a17 = _a17 > _r8 ? _r8 : _a17;
              _i10 = _i10 > _r8 ? _r8 : _i10;
              _t58 = _t58 < 0 ? 0 : _t58;
              _e36 = _e36 < 0 ? 0 : _e36;
              _a17 = _a17 < 0 ? 0 : _a17;
              _i10 = _i10 < 0 ? 0 : _i10;
              T.arc(g + _i10, c + _i10, _i10, -Math.PI, -Math.PI / 2);
              T.arc(_o5.x - _t58, c + _t58, _t58, -Math.PI / 2, 0);
              T.arc(_o5.x - _e36, c + h - _e36, _e36, 0, Math.PI / 2);
              T.arc(g + _a17, c + h - _a17, _a17, Math.PI / 2, Math.PI);
            } else {
              T.moveTo(n, r);
              T.lineTo(_o5.x, r);
              T.lineTo(_o5.x, r + _o5.width);
              T.lineTo(n, r + _o5.width);
              T.lineTo(n, r);
              T.setLineWidth(1);
              T.setStrokeStyle(u);
            }
      ...
      case "stack":
        ...
        for (var _e37 = 0; _e37 < i.length; _e37++) {
          var _t59 = i[_e37];
          if (_t59 !== null && _e37 > C && _e37 < D) {
            T.beginPath();
            var l = _t59.color || a.color;
            var n = _t59.x0;
            T.setFillStyle(l);
            T.moveTo(n, _t59.y - _t59.width / 2);
            T.fillRect(n, _t59.y - _t59.width / 2, _t59.height, _t59.width);
            T.closePath();
            T.fill();
          }
        }
...
function drawCandleDataPoints(e, t, h, c, d) {
  ...
  if (s.average.show || t) {
    t.forEach(function (e, t) {
      ...
      for (var _t60 = 0; _t60 < l.length; _t60++) {
        var _i11 = l[_t60];
        d.beginPath();
        ...
        if (_i11.length === 1) {
          ...
          d.arc(_i11[0].x, _i11[0].y, 1, 0, 2 * Math.PI);
        } else {
          d.moveTo(_i11[0].x, _i11[0].y);
          var _a18 = 0;
          for (var _e38 = 0; _e38 < _i11.length; _e38++) {
            var _t61 = _i11[_e38];
            if (_a18 == 0 && _t61.x > u) {
              d.moveTo(_t61.x, _t61.y);
              _a18 = 1;
            }
            if (_e38 > 0 && _t61.x > u && _t61.x < m) {
              var s = createCurveControlPoints(_i11, _e38 - 1);
              d.bezierCurveTo(s.ctrA.x, s.ctrA.y, s.ctrB.x, s.ctrB.y, _t61.x, _t61.y);
            }
          }
          d.moveTo(_i11[0].x, _i11[0].y);
        }
  ...
  e.forEach(function (t, e) {
    ...
    for (var _e39 = 0; _e39 < l[0].length; _e39++) {
      if (_e39 > p && _e39 < v) {
        var _t62 = l[0][_e39];
        d.beginPath();
        if (o[_e39][1] - o[_e39][0] > 0) {
          d.setStrokeStyle(s.color.upLine);
          d.setFillStyle(s.color.upFill);
          d.setLineWidth(1 * h.pix);
          d.moveTo(_t62[3].x, _t62[3].y);
          d.lineTo(_t62[1].x, _t62[1].y);
          d.lineTo(_t62[1].x - f / 4, _t62[1].y);
          d.lineTo(_t62[0].x - f / 4, _t62[0].y);
          d.lineTo(_t62[0].x, _t62[0].y);
          d.lineTo(_t62[2].x, _t62[2].y);
          d.lineTo(_t62[0].x, _t62[0].y);
          d.lineTo(_t62[0].x + f / 4, _t62[0].y);
          d.lineTo(_t62[1].x + f / 4, _t62[1].y);
          d.lineTo(_t62[1].x, _t62[1].y);
...
function drawAreaDataPoints(t, s, h, c) {
  ...
  var e = s.chartData.xAxisData,
    f = e.xAxisPoints,
    p = e.eachSpacing;
  var y = s.height - s.area[2];
  var v = [];
  c.save();
  var u = 0;
  var g = s.width + p;
  ...
  t.forEach(function (e, t) {
    ...
    v.push(n);
    var l = splitPoints(n, e);
    for (var _t63 = 0; _t63 < l.length; _t63++) {
      var _r9 = l[_t63];
      c.beginPath();
      c.setStrokeStyle(hexToRgb(e.color, x.opacity));
      if (x.gradient) {
        var _t64 = c.createLinearGradient(0, s.area[0], 0, s.height - s.area[2]);
        _t64.addColorStop("0", hexToRgb(e.color, x.opacity));
        _t64.addColorStop("1.0", hexToRgb("#FFFFFF", .1));
        c.setFillStyle(_t64);
      } else {
      ...
      if (_r9.length > 1) {
        var _t65 = _r9[0];
        var _e40 = _r9[_r9.length - 1];
        c.moveTo(_t65.x, _t65.y);
        var _i12 = 0;
        if (x.type === "curve") {
          for (var _a19 = 0; _a19 < _r9.length; _a19++) {
            var _e41 = _r9[_a19];
            if (_i12 == 0 && _e41.x > u) {
              c.moveTo(_e41.x, _e41.y);
              _i12 = 1;
            }
            if (_a19 > 0 && _e41.x > u && _e41.x < g) {
              var _t66 = createCurveControlPoints(_r9, _a19 - 1);
              c.bezierCurveTo(_t66.ctrA.x, _t66.ctrA.y, _t66.ctrB.x, _t66.ctrB.y, _e41.x, _e41.y);
            }
          }
        }
        if (x.type === "straight") {
          for (var _e42 = 0; _e42 < _r9.length; _e42++) {
            var _t67 = _r9[_e42];
            if (_i12 == 0 && _t67.x > u) {
              c.moveTo(_t67.x, _t67.y);
              _i12 = 1;
            }
            if (_e42 > 0 && _t67.x > u && _t67.x < g) {
              c.lineTo(_t67.x, _t67.y);
            }
          }
        }
        if (x.type === "step") {
          for (var _e43 = 0; _e43 < _r9.length; _e43++) {
            var _t68 = _r9[_e43];
            if (_i12 == 0 && _t68.x > u) {
              c.moveTo(_t68.x, _t68.y);
              _i12 = 1;
            }
            if (_e43 > 0 && _t68.x > u && _t68.x < g) {
              c.lineTo(_t68.x, _r9[_e43 - 1].y);
              c.lineTo(_t68.x, _t68.y);
            }
          }
        }
        c.lineTo(_e40.x, y);
        c.lineTo(_t65.x, y);
        c.lineTo(_t65.x, _t65.y);
      } else {
        var _t69 = _r9[0];
        c.moveTo(_t69.x - p / 2, _t69.y);
      }
      c.closePath();
      c.fill();
      if (x.addLine) {
        if (e.lineType == "dash") {
          var _t70 = e.dashLength ? e.dashLength : 8;
          _t70 *= s.pix;
          c.setLineDash([_t70, _t70]);
        }
        c.beginPath();
        c.setStrokeStyle(e.color);
        c.setLineWidth(x.width * s.pix);
        if (_r9.length === 1) {
          c.moveTo(_r9[0].x, _r9[0].y);
        } else {
          c.moveTo(_r9[0].x, _r9[0].y);
          var _i13 = 0;
          if (x.type === "curve") {
            for (var _a20 = 0; _a20 < _r9.length; _a20++) {
              var _e44 = _r9[_a20];
              if (_i13 == 0 && _e44.x > u) {
                c.moveTo(_e44.x, _e44.y);
                _i13 = 1;
              }
              if (_a20 > 0 && _e44.x > u && _e44.x < g) {
                var _t71 = createCurveControlPoints(_r9, _a20 - 1);
                c.bezierCurveTo(_t71.ctrA.x, _t71.ctrA.y, _t71.ctrB.x, _t71.ctrB.y, _e44.x, _e44.y);
              }
            }
          }
          if (x.type === "straight") {
            for (var _e45 = 0; _e45 < _r9.length; _e45++) {
              var _t72 = _r9[_e45];
              if (_i13 == 0 && _t72.x > u) {
                c.moveTo(_t72.x, _t72.y);
                _i13 = 1;
              }
              if (_e45 > 0 && _t72.x > u && _t72.x < g) {
                c.lineTo(_t72.x, _t72.y);
              }
            }
          }
          if (x.type === "step") {
            for (var _e46 = 0; _e46 < _r9.length; _e46++) {
              var _t73 = _r9[_e46];
              if (_i13 == 0 && _t73.x > u) {
                c.moveTo(_t73.x, _t73.y);
                _i13 = 1;
              }
              if (_e46 > 0 && _t73.x > u && _t73.x < g) {
                c.lineTo(_t73.x, _r9[_e46 - 1].y);
                c.lineTo(_t73.x, _t73.y);
              }
            }
          }
          c.moveTo(_r9[0].x, _r9[0].y);
...
function drawLineDataPoints(t, d, x, f) {
  ...
  t.forEach(function (e, c) {
    ...
    if (e.lineType == "dash") {
      var _t74 = e.dashLength ? e.dashLength : 8;
      _t74 *= d.pix;
      f.setLineDash([_t74, _t74]);
    }
    f.beginPath();
    var l = e.color;
    ...
    n.forEach(function (i, t) {
      if (i.length === 1) {
        ...
        var _a21 = 0;
        if (u.type === "curve") {
          for (var _e47 = 0; _e47 < i.length; _e47++) {
            var _t75 = i[_e47];
            if (_a21 == 0 && _t75.x > v) {
              f.moveTo(_t75.x, _t75.y);
              _a21 = 1;
            }
            if (_e47 > 0 && _t75.x > v && _t75.x < m) {
              var r = createCurveControlPoints(i, _e47 - 1);
              f.bezierCurveTo(r.ctrA.x, r.ctrA.y, r.ctrB.x, r.ctrB.y, _t75.x, _t75.y);
            }
          }
        }
        if (u.type === "straight") {
          for (var _e48 = 0; _e48 < i.length; _e48++) {
            var _t76 = i[_e48];
            if (_a21 == 0 && _t76.x > v) {
              f.moveTo(_t76.x, _t76.y);
              _a21 = 1;
            }
            if (_e48 > 0 && _t76.x > v && _t76.x < m) {
              f.lineTo(_t76.x, _t76.y);
            }
          }
        }
        if (u.type === "step") {
          for (var _e49 = 0; _e49 < i.length; _e49++) {
            var _t77 = i[_e49];
            if (_a21 == 0 && _t77.x > v) {
              f.moveTo(_t77.x, _t77.y);
              _a21 = 1;
            }
            if (_e49 > 0 && _t77.x > v && _t77.x < m) {
              f.lineTo(_t77.x, i[_e49 - 1].y);
              f.lineTo(_t77.x, _t77.y);
            }
          }
        }
        f.moveTo(i[0].x, i[0].y);
...
function drawMixDataPoints(t, v, m, T) {
  ...
  t.forEach(function (n, t) {
    ...
    if (n.type == "column") {
      ...
      for (var _t78 = 0; _t78 < a.length; _t78++) {
        var _o6 = a[_t78];
        if (_o6 !== null && _t78 > R && _t78 < I) {
          var l = _o6.x - _o6.width / 2;
          var s = v.height - _o6.y - v.area[2];
          T.beginPath();
          var e = _o6.color || n.color;
          var u = _o6.color || n.color;
          if (w.linearType !== "none") {
            var i = T.createLinearGradient(l, _o6.y, l, v.height - v.area[2]);
          ...
          if (w.barBorderRadius && w.barBorderRadius.length === 4 || w.barBorderCircle) {
            ...
            var c = _o6.y;
            var d = _o6.width;
            var _s3 = v.height - v.area[2] - _o6.y;
            if (w.barBorderCircle) {
              w.barBorderRadius = [d / 2, d / 2, 0, 0];
            }
            var _w$barBorderRadius = (0, _slicedToArray2.default)(w.barBorderRadius, 4),
              _t79 = _w$barBorderRadius[0],
              _e50 = _w$barBorderRadius[1],
              _a22 = _w$barBorderRadius[2],
              _i14 = _w$barBorderRadius[3];
            var _r10 = Math.min(d / 2, _s3 / 2);
            _t79 = _t79 > _r10 ? _r10 : _t79;
            _e50 = _e50 > _r10 ? _r10 : _e50;
            _a22 = _a22 > _r10 ? _r10 : _a22;
            _i14 = _i14 > _r10 ? _r10 : _i14;
            _t79 = _t79 < 0 ? 0 : _t79;
            _e50 = _e50 < 0 ? 0 : _e50;
            _a22 = _a22 < 0 ? 0 : _a22;
            _i14 = _i14 < 0 ? 0 : _i14;
            T.arc(h + _t79, c + _t79, _t79, -Math.PI, -Math.PI / 2);
            T.arc(h + d - _e50, c + _e50, _e50, -Math.PI / 2, 0);
            T.arc(h + d - _a22, c + _s3 - _a22, _a22, 0, Math.PI / 2);
            T.arc(h + _i14, c + _s3 - _i14, _i14, Math.PI / 2, Math.PI);
          } else {
            T.moveTo(l, _o6.y);
            T.lineTo(l + _o6.width, _o6.y);
            T.lineTo(l + _o6.width, v.height - v.area[2]);
    ...
    if (n.type == "area") {
      var _e51 = splitPoints(a, n);
      for (var _t80 = 0; _t80 < _e51.length; _t80++) {
        var _i15 = _e51[_t80];
        T.beginPath();
        T.setStrokeStyle(n.color);
        T.setStrokeStyle(hexToRgb(n.color, A.opacity));
        if (A.gradient) {
          var _t81 = T.createLinearGradient(0, v.area[0], 0, v.height - v.area[2]);
          _t81.addColorStop("0", hexToRgb(n.color, A.opacity));
          _t81.addColorStop("1.0", hexToRgb("#FFFFFF", .1));
          T.setFillStyle(_t81);
        } else {
        ...
        if (_i15.length > 1) {
          var r = _i15[0];
          var _t82 = _i15[_i15.length - 1];
          T.moveTo(r.x, r.y);
          var _a23 = 0;
          if (n.style === "curve") {
            for (var _e52 = 0; _e52 < _i15.length; _e52++) {
              var _t83 = _i15[_e52];
              if (_a23 == 0 && _t83.x > P) {
                T.moveTo(_t83.x, _t83.y);
                _a23 = 1;
              }
              if (_e52 > 0 && _t83.x > P && _t83.x < C) {
                var g = createCurveControlPoints(_i15, _e52 - 1);
                T.bezierCurveTo(g.ctrA.x, g.ctrA.y, g.ctrB.x, g.ctrB.y, _t83.x, _t83.y);
              }
            }
          } else {
            for (var _e53 = 0; _e53 < _i15.length; _e53++) {
              var _t84 = _i15[_e53];
              if (_a23 == 0 && _t84.x > P) {
                T.moveTo(_t84.x, _t84.y);
                _a23 = 1;
              }
              if (_e53 > 0 && _t84.x > P && _t84.x < C) {
                T.lineTo(_t84.x, _t84.y);
              }
            }
          }
          T.lineTo(_t82.x, L);
    ...
    if (n.type == "line") {
      ...
      y.forEach(function (i, t) {
        if (n.lineType == "dash") {
          var _t86 = n.dashLength ? n.dashLength : 8;
          _t86 *= v.pix;
          T.setLineDash([_t86, _t86]);
        }
        T.beginPath();
        T.setStrokeStyle(n.color);
        ...
        if (i.length === 1) {
          ...
          var _a24 = 0;
          if (n.style == "curve") {
            for (var _e54 = 0; _e54 < i.length; _e54++) {
              var _t87 = i[_e54];
              if (_a24 == 0 && _t87.x > P) {
                T.moveTo(_t87.x, _t87.y);
                _a24 = 1;
              }
              if (_e54 > 0 && _t87.x > P && _t87.x < C) {
                var r = createCurveControlPoints(i, _e54 - 1);
                T.bezierCurveTo(r.ctrA.x, r.ctrA.y, r.ctrB.x, r.ctrB.y, _t87.x, _t87.y);
              }
            }
          } else {
            for (var _e55 = 0; _e55 < i.length; _e55++) {
              var _t88 = i[_e55];
              if (_a24 == 0 && _t88.x > P) {
                T.moveTo(_t88.x, _t88.y);
                _a24 = 1;
              }
              if (_e55 > 0 && _t88.x > P && _t88.x < C) {
                T.lineTo(_t88.x, _t88.y);
              }
            }
          }
          T.moveTo(i[0].x, i[0].y);
  ...
  if (h.xAxis.disabled !== true) {
    ...
    if (h.xAxis.labelCount) {
      if (h.xAxis.itemCount) {
        _t89 = Math.ceil(r.length / h.xAxis.itemCount * h.xAxis.labelCount);
      } else {
        _t89 = h.xAxis.labelCount;
      }
      _t89 -= 1;
    }
    var _e56 = Math.ceil(r.length / _t89);
    var _a25 = [];
    var _i16 = r.length;
    for (var _t90 = 0; _t90 < _i16; _t90++) {
      if (_t90 % _e56 !== 0) {
        _a25.push("");
      } else {
        _a25.push(r[_t90]);
...
function drawYAxisGrid(c, e, d, a) {
  ...
  var t = e.height - e.area[0] - e.area[2];
  var i = t / e.yAxis.splitNumber;
  var r = e.area[3];
  var o = e.chartData.xAxisData.xAxisPoints,
  ...
  for (var _t91 = h; _t91 < e.yAxis.splitNumber + 1; _t91++) {
    s.push(e.height - e.area[2] - i * _t91);
  }
  a.save();
...
function drawYAxis(e, h, a, c) {
  ...
  c.stroke();
  var d = h.area[3];
  var x = h.width - h.area[1];
  var f = h.area[3] + (h.width - h.area[1] - h.area[3]) / 2;
  if (h.yAxis.data) {
    var _loop3 = function _loop3(_e57) {
      var s = h.yAxis.data[_e57];
      p = [];
      if (s.type === "categories") {
        for (var _t92 = 0; _t92 <= s.categories.length; _t92++) {
          p.push(h.area[0] + i / s.categories.length / 2 + i / s.categories.length * _t92);
        }
      } else {
        for (var _t93 = 0; _t93 <= h.yAxis.splitNumber; _t93++) {
          p.push(h.area[0] + r * _t93);
        }
      }
      if (s.disabled !== true) {
        var _t94 = h.chartData.yAxisData.rangesFormat[_e57];
        var _o7 = s.fontSize ? s.fontSize * h.pix : a.fontSize;
        var _n3 = h.chartData.yAxisData.yAxisWidth[_e57];
        var l = s.textAlign || "right";
        _t94.forEach(function (t, e) {
          var a = p[e];
          c.beginPath();
          c.setFontSize(_o7);
          c.setLineWidth(1 * h.pix);
          ...
          if (_n3.position == "left") {
            ...
            c.fillText(String(t), i, a + _o7 / 2 - 3 * h.pix);
          } else if (_n3.position == "right") {
            if (s.calibration == true) {
              c.moveTo(x, a);
        ...
        if (h.yAxis.showTitle) {
          var _t95 = s.titleFontSize * h.pix || a.fontSize;
          var _e58 = s.title;
          c.beginPath();
          c.setFontSize(_t95);
          c.setFillStyle(s.titleFontColor || h.fontColor);
          if (_n3.position == "left") {
            c.fillText(_e58, d - measureText(_e58, _t95, c) / 2 + (s.titleOffsetX || 0), h.area[0] - (10 - (s.titleOffsetY || 0)) * h.pix);
          } else if (_n3.position == "right") {
            c.fillText(_e58, x - measureText(_e58, _t95, c) / 2 + (s.titleOffsetX || 0), h.area[0] - (10 - (s.titleOffsetY || 0)) * h.pix);
          } else if (_n3.position == "center") {
            c.fillText(_e58, f - measureText(_e58, _t95, c) / 2 + (s.titleOffsetX || 0), h.area[0] - (10 - (s.titleOffsetY || 0)) * h.pix);
          }
          c.closePath();
          c.stroke();
        }
        if (_n3.position == "left") {
          d -= _n3.width + h.yAxis.padding * h.pix;
        } else {
          x += _n3.width + h.yAxis.padding * h.pix;
        }
      }
    };
    for (var _e57 = 0; _e57 < h.yAxis.data.length; _e57++) {
      var p;
      _loop3(_e57);
    }
  }
...
function drawLegend(t, l, y, s, e) {
  ...
  var a = h.points;
  var c = h.area;
  var d = l.legend.padding * l.pix;
  var x = l.legend.fontSize * l.pix;
  var f = 15 * l.pix;
  var p = 5 * l.pix;
  var u = l.legend.itemGap * l.pix;
  var g = Math.max(l.legend.lineHeight * l.pix, x);
  s.beginPath();
  ...
  a.forEach(function (i, t) {
    ...
    for (var _a26 = 0; _a26 < i.length; _a26++) {
      var _t96 = i[_a26];
      _t96.area = [0, 0, 0, 0];
      _t96.area[0] = r;
      _t96.area[1] = o;
      ...
      s.setStrokeStyle(_t96.show ? _t96.color : l.legend.hiddenColor);
      s.setFillStyle(_t96.show ? _t96.color : l.legend.hiddenColor);
      switch (_t96.legendShape) {
        case "line":
      ...
      r += f + p;
      var _e59 = .5 * g + .5 * x - 2;
      var n = _t96.legendText ? _t96.legendText : _t96.name;
      s.beginPath();
      s.setFontSize(x);
      s.setFillStyle(_t96.show ? l.legend.fontColor : l.legend.hiddenColor);
      s.fillText(n, r, o + _e59);
      s.closePath();
      s.stroke();
      if (l.legend.position == "top" || l.legend.position == "bottom") {
        ...
        _t96.area[2] = r + measureText(n, x, s) + u;
        r -= f + p;
        o += g;
      }
    }
...
function drawArcbarDataPoints(a, i, t, r) {
  ...
  for (var _e60 = 0; _e60 < a.length; _e60++) {
    var _t97 = a[_e60];
    ...
    r.beginPath();
    if (o.type == "default") {
      r.arc(n.x, n.y, l - (o.width * i.pix + o.gap * i.pix) * _e60, o.startAngle * Math.PI, o.endAngle * Math.PI, o.direction == "ccw");
    } else {
      r.arc(n.x, n.y, l - (o.width * i.pix + o.gap * i.pix) * _e60, 0, 2 * Math.PI, o.direction == "ccw");
    }
    r.stroke();
    var s = _t97.color;
    if (o.linearType == "custom") {
      var h = r.createLinearGradient(n.x - l, n.y, n.x + l, n.y);
      h.addColorStop(1, hexToRgb(o.customColor[_t97.linearIndex], 1));
      h.addColorStop(0, hexToRgb(_t97.color, 1));
      s = h;
    }
    r.setLineWidth(o.width * i.pix);
    r.setStrokeStyle(s);
    r.setLineCap(o.lineCap);
    r.beginPath();
    r.arc(n.x, n.y, l - (o.width * i.pix + o.gap * i.pix) * _e60, o.startAngle * Math.PI, _t97._proportion_ * Math.PI, o.direction == "ccw");
    r.stroke();
  }
...
function drawGaugeDataPoints(n, h, c, t, d) {
  ...
  if (f.type == "progress") {
    var v = u - f.width * 3;
    d.beginPath();
    var _t98 = d.createLinearGradient(p.x, p.y - v, p.x, p.y + v);
    _t98.addColorStop("0", hexToRgb(h[0].color, .3));
    _t98.addColorStop("1.0", hexToRgb("#FFFFFF", .1));
    d.setFillStyle(_t98);
    ...
    var e = y / f.splitLine.splitNumber;
    var a = y / f.splitLine.splitNumber / f.splitLine.childNumber;
    var i = -u - f.width * .5 - f.splitLine.fixRadius;
    var r = -u - f.width - f.splitLine.fixRadius + f.splitLine.width;
    d.save();
    d.translate(p.x, p.y);
    d.rotate((f.startAngle - 1) * Math.PI);
    var o = f.splitLine.splitNumber * f.splitLine.childNumber + 1;
    var _n4 = h[0].data * x;
    for (var _t99 = 0; _t99 < o; _t99++) {
      d.beginPath();
      if (_n4 > _t99 / o) {
    ...
    var s = d.createLinearGradient(0, -l * .6, 0, l * .6);
    ...
    d.setLineWidth(f.width);
    d.setLineCap("butt");
    for (var _e62 = 0; _e62 < n.length; _e62++) {
      var _t100 = n[_e62];
      d.beginPath();
      d.setStrokeStyle(_t100.color);
      d.arc(p.x, p.y, u, _t100._startAngle_ * Math.PI, _t100._endAngle_ * Math.PI, false);
      d.stroke();
    }
    d.save();
    if (f.endAngle < f.startAngle) {
    ...
    var _e61 = y / f.splitLine.splitNumber;
    var _a27 = y / f.splitLine.splitNumber / f.splitLine.childNumber;
    var _i17 = -u - f.width * .5 - f.splitLine.fixRadius;
    var _r11 = -u - f.width * .5 - f.splitLine.fixRadius + f.splitLine.width;
    var _o8 = -u - f.width * .5 - f.splitLine.fixRadius + f.splitLine.childWidth;
    d.translate(p.x, p.y);
    d.rotate((f.startAngle - 1) * Math.PI);
    for (var _t101 = 0; _t101 < f.splitLine.splitNumber + 1; _t101++) {
      d.beginPath();
      ...
      d.lineTo(_r11, 0);
      d.stroke();
      d.rotate(_e61 * Math.PI);
    }
    d.restore();
    d.save();
    d.translate(p.x, p.y);
    d.rotate((f.startAngle - 1) * Math.PI);
    for (var _t102 = 0; _t102 < f.splitLine.splitNumber * f.splitLine.childNumber + 1; _t102++) {
      d.beginPath();
      d.setStrokeStyle(f.splitLine.color);
      ...
      d.lineTo(_o8, 0);
      d.stroke();
      d.rotate(_a27 * Math.PI);
    }
    d.restore();
    h = getGaugeDataPoints(h, n, f, x);
    for (var _e63 = 0; _e63 < h.length; _e63++) {
      var _t103 = h[_e63];
      d.save();
      d.translate(p.x, p.y);
      d.rotate((_t103._proportion_ - 1) * Math.PI);
      d.beginPath();
      d.setFillStyle(_t103.color);
...
function drawRadarDataPoints(o, n, i, l) {
  ...
  if (s.axisLabel === true) {
    var p = Math.max(s.max, Math.max.apply(null, dataCombine(o)));
    var u = c / s.gridCount;
    var g = n.fontSize * n.pix;
    l.setFontSize(g);
    l.setFillStyle(n.fontColor);
    l.setTextAlign("left");
    for (var e = 0; e < s.gridCount + 1; e++) {
      var _t104 = e * p / s.gridCount;
      _t104 = _t104.toFixed(s.axisLabelTofix);
      l.fillText(String(_t104), h.x + 3 * n.pix, h.y - e * u + g / 2);
    }
  }
...
function isRayIntersectsSegment(t, e, a) {
  ...
  var i = a[0] - (a[0] - e[0]) * (a[1] - t[1]) / (a[1] - e[1]);
  if (i < t[0]) {
    return false;
  } else {
    return true;
...
function isPoiWithinPoly(r, e, o) {
  ...
  for (var t = 0; t < e.length; t++) {
    ...
    for (var a = 0; a < i.length - 1; a++) {
      ...
      var _e64 = i[a + 1];
      if (o) {
        _t105 = lonlat2mercator(i[a][0], i[a][1]);
        _e64 = lonlat2mercator(i[a + 1][0], i[a + 1][1]);
      }
      if (isRayIntersectsSegment(r, _t105, _e64)) {
        n += 1;
      }
    }
  }
  ...
  if (i.dataLabel == true) {
    for (var c = 0; c < l.length; c++) {
      ...
      if (b) {
        ...
        var _t106 = l[c].textSize * i.pix || d.fontSize;
        var _e65 = l[c].textColor || i.fontColor;
        if (o.active && o.activeTextColor && i.tooltip && i.tooltip.index == c) {
          _e65 = o.activeTextColor;
        }
        var _a28 = l[c].properties.name;
        r.beginPath();
        r.setFontSize(_t106);
        r.setFillStyle(_e65);
        r.fillText(_a28, n.x - measureText(_a28, _t106, r) / 2, n.y + _t106 / 2);
        r.closePath();
        r.stroke();
      }
    }
  ...
  switch (t) {
    case "normal":
      for (var l = 0; l < x.length; l++) {
        var _t107 = x[l].name;
        var e = x[l].textSize * c.pix;
        var a = measureText(_t107, e, d);
        var i = void 0,
          r = void 0;
        var o = void 0;
        var n = 0;
        while (true) {
          ...
          var _t108 = collisionNew(o, x, c.width, c.height);
          if (!_t108) break;
          if (n == 1e3) {
            o = [-100, -100, -100, -100];
            break;
    ...
    case "vertical":
      ...
      for (var h = 0; h < x.length; h++) {
        var _t109 = x[h].name;
        var _e66 = x[h].textSize * c.pix;
        var _a29 = measureText(_t109, _e66, d);
        var _i18 = f();
        var _r12 = void 0,
          _o9 = void 0,
          _n5 = void 0,
        ...
        while (true) {
          ...
          var _t110 = void 0;
          if (_i18) {
            _r12 = normalInt(-c.width / 2, c.width / 2, 5) - _a29 / 2;
            _o9 = normalInt(-c.height / 2, c.height / 2, 5) + _e66 / 2;
            _n5 = [_o9 - 5 - _a29 + c.width / 2, -_r12 - 5 + c.height / 2, _o9 + 5 + c.width / 2, -_r12 + _e66 + 5 + c.height / 2];
            _l2 = [c.width - (c.width / 2 - c.height / 2) - (-_r12 + _e66 + 5 + c.height / 2) - 5, c.height / 2 - c.width / 2 + (_o9 - 5 - _a29 + c.width / 2) - 5, c.width - (c.width / 2 - c.height / 2) - (-_r12 + _e66 + 5 + c.height / 2) + _e66, c.height / 2 - c.width / 2 + (_o9 - 5 - _a29 + c.width / 2) + _a29 + 5];
            _t110 = collisionNew(_l2, x, c.height, c.width);
          } else {
            _r12 = normalInt(-c.width / 2, c.width / 2, 5) - _a29 / 2;
            _o9 = normalInt(-c.height / 2, c.height / 2, 5) + _e66 / 2;
            _n5 = [_r12 - 5 + c.width / 2, _o9 - 5 - _e66 + c.height / 2, _r12 + _a29 + 5 + c.width / 2, _o9 + 5 + c.height / 2];
            _t110 = collisionNew(_n5, x, c.width, c.height);
          }
          if (!_t110) break;
          if (s == 1e3) {
            _n5 = [-1e3, -1e3, -1e3, -1e3];
...
function drawWordCloudDataPoints(t, r, e, o) {
  ...
  o.fill();
  o.save();
  var l = r.chartData.wordCloudData;
  ...
  for (var i = 0; i < l.length; i++) {
    ...
    var _t111 = l[i].name;
    var _e67 = l[i].textSize * r.pix;
    var _a30 = measureText(_t111, _e67, o);
    o.beginPath();
    ...
    if (l[i].rotate) {
      if (l[i].areav[0] > 0) {
        if (r.tooltip) {
          if (r.tooltip.index == i) {
            o.strokeText(_t111, (l[i].areav[0] + 5 - r.width / 2) * n - _a30 * (1 - n) / 2, (l[i].areav[1] + 5 + _e67 - r.height / 2) * n);
          } else {
            o.fillText(_t111, (l[i].areav[0] + 5 - r.width / 2) * n - _a30 * (1 - n) / 2, (l[i].areav[1] + 5 + _e67 - r.height / 2) * n);
          }
        } else {
          o.fillText(_t111, (l[i].areav[0] + 5 - r.width / 2) * n - _a30 * (1 - n) / 2, (l[i].areav[1] + 5 + _e67 - r.height / 2) * n);
        }
      ...
      if (l[i].area[0] > 0) {
        if (r.tooltip) {
          if (r.tooltip.index == i) {
            o.strokeText(_t111, (l[i].area[0] + 5 - r.width / 2) * n - _a30 * (1 - n) / 2, (l[i].area[1] + 5 + _e67 - r.height / 2) * n);
          } else {
            o.fillText(_t111, (l[i].area[0] + 5 - r.width / 2) * n - _a30 * (1 - n) / 2, (l[i].area[1] + 5 + _e67 - r.height / 2) * n);
          }
        } else {
          o.fillText(_t111, (l[i].area[0] + 5 - r.width / 2) * n - _a30 * (1 - n) / 2, (l[i].area[1] + 5 + _e67 - r.height / 2) * n);
        }
...
function drawFunnelDataPoints(t, e, c, a) {
  ...
  var r = (e.height - e.area[0] - e.area[2]) / t.length;
  var o = {
    x: e.area[3] + (e.width - e.area[1] - e.area[3]) / 2,
    y: e.height - e.area[2]
  };
  var n = i.activeWidth * e.pix;
  var x = Math.min((e.width - e.area[1] - e.area[3]) / 2 - n, (e.height - e.area[0] - e.area[2]) / 2 - n);
  var l = getFunnelDataPoints(t, x, i, r, d);
  a.save();
  a.translate(o.x, o.y);
  i.customColor = fillCustomColor(i.linearType, i.customColor, t, c);
  if (i.type == "pyramid") {
    for (var _t112 = 0; _t112 < l.length; _t112++) {
      if (_t112 == l.length - 1) {
        if (e.tooltip) {
          if (e.tooltip.index == _t112) {
            a.beginPath();
            a.setFillStyle(hexToRgb(l[_t112].color, i.activeOpacity));
            a.moveTo(-n, -r);
            a.lineTo(-l[_t112].radius - n, 0);
            a.lineTo(l[_t112].radius + n, 0);
            a.lineTo(n, -r);
            a.lineTo(-n, -r);
            a.closePath();
        ...
        l[_t112].funnelArea = [o.x - l[_t112].radius, o.y - r * (_t112 + 1), o.x + l[_t112].radius, o.y - r * _t112];
        a.beginPath();
        a.setLineWidth(i.borderWidth * e.pix);
        a.setStrokeStyle(i.borderColor);
        var s = hexToRgb(l[_t112].color, i.fillOpacity);
        if (i.linearType == "custom") {
          var h = a.createLinearGradient(l[_t112].radius, -r, -l[_t112].radius, -r);
          h.addColorStop(0, hexToRgb(l[_t112].color, i.fillOpacity));
          h.addColorStop(.5, hexToRgb(i.customColor[l[_t112].linearIndex], i.fillOpacity));
          h.addColorStop(1, hexToRgb(l[_t112].color, i.fillOpacity));
          s = h;
        }
        a.setFillStyle(s);
        a.moveTo(0, -r);
        a.lineTo(-l[_t112].radius, 0);
        a.lineTo(l[_t112].radius, 0);
        a.lineTo(0, -r);
        a.closePath();
        a.fill();
    ...
    for (var _t113 = 0; _t113 < l.length; _t113++) {
      if (_t113 == l.length - 1) {
        if (e.tooltip) {
          if (e.tooltip.index == _t113) {
            a.beginPath();
            a.setFillStyle(hexToRgb(l[_t113].color, i.activeOpacity));
            a.moveTo(-n - i.minSize / 2, 0);
            a.lineTo(-l[_t113].radius - n, -r);
            a.lineTo(l[_t113].radius + n, -r);
        ...
        l[_t113].funnelArea = [o.x - l[_t113].radius, o.y - r, o.x + l[_t113].radius, o.y];
        a.beginPath();
        a.setLineWidth(i.borderWidth * e.pix);
        a.setStrokeStyle(i.borderColor);
        var s = hexToRgb(l[_t113].color, i.fillOpacity);
        if (i.linearType == "custom") {
          var h = a.createLinearGradient(l[_t113].radius, -r, -l[_t113].radius, -r);
          h.addColorStop(0, hexToRgb(l[_t113].color, i.fillOpacity));
          h.addColorStop(.5, hexToRgb(i.customColor[l[_t113].linearIndex], i.fillOpacity));
          h.addColorStop(1, hexToRgb(l[_t113].color, i.fillOpacity));
          s = h;
        }
        a.setFillStyle(s);
        a.moveTo(0, 0);
        a.lineTo(-i.minSize / 2, 0);
        a.lineTo(-l[_t113].radius, -r);
        a.lineTo(l[_t113].radius, -r);
        a.lineTo(i.minSize / 2, 0);
        a.lineTo(0, 0);
        a.closePath();
        ...
        l[_t113].funnelArea = [o.x - l[_t113].radius, o.y - r * (l.length - _t113), o.x + l[_t113].radius, o.y - r * (l.length - _t113 - 1)];
        a.beginPath();
        a.setLineWidth(i.borderWidth * e.pix);
        a.setStrokeStyle(i.borderColor);
        var s = hexToRgb(l[_t113].color, i.fillOpacity);
...
function drawFunnelText(l, s, h, c, d, x, f) {
  for (var n = 0; n < l.length; n++) {
    ...
    var e = void 0,
      ...
      i = void 0,
      r = void 0;
    var o = t.formatter ? t.formatter(t, n, l, s) : util.toFixed(t._proportion_ * 100) + "%";
...
function drawFunnelCenterText(r, o, n, l, t, e, s) {
  for (var i = 0; i < r.length; i++) {
    ...
    var _e68 = void 0,
      a = void 0;
    if (_t114.centerText) {
      _e68 = _t114.funnelArea[1] + l / 2;
      a = _t114.centerTextSize * o.pix || o.fontSize * o.pix;
      n.beginPath();
      n.setFontSize(a);
      n.setFillStyle(_t114.centerTextColor || "#FFFFFF");
      n.fillText(_t114.centerText, s.x - measureText(_t114.centerText, a, n) / 2, _e68 + a / 2 - 2);
      n.closePath();
      n.stroke();
      n.closePath();
    }
...
function drawCharts(t, l, n, s) {
  ...
  if (t === "mount") {
    d = [];
    for (var _t115 = 0; _t115 < c.length; _t115++) {
      if (c[_t115].show !== false) d.push(c[_t115].name);
    }
    l.categories = d;
  }
  c = fillSeries(c, l, n);
  ...
  var x = null;
  if (t == "candle") {
    var _t116 = assign({}, l.extra.candle.average);
    if (_t116.show) {
      x = calCandleMA(_t116.day, _t116.name, _t116.color, c[0].data);
      x = fillSeries(x, l, n);
      l.seriesMA = x;
    } else if (l.seriesMA) {
  ...
  l.area = new Array(4);
  for (var _t117 = 0; _t117 < 4; _t117++) {
    l.area[_t117] = l.padding[_t117] * l.pix;
  }
  ...
  if (l.type === "line" || l.type === "column" || l.type === "mount" || l.type === "area" || l.type === "mix" || l.type === "candle" || l.type === "scatter" || l.type === "bubble" || l.type === "bar") {
    ...
    if (l.yAxis.showTitle) {
      var _e70 = 0;
      for (var _t118 = 0; _t118 < l.yAxis.data.length; _t118++) {
        _e70 = Math.max(_e70, l.yAxis.data[_t118].titleFontSize ? l.yAxis.data[_t118].titleFontSize * l.pix : n.fontSize);
      }
      l.area[0] += _e70;
    }
    var _e69 = 0,
      _a31 = 0;
    for (var _t119 = 0; _t119 < i.length; _t119++) {
      if (i[_t119].position == "left") {
        if (_a31 > 0) {
          l.area[3] += i[_t119].width + l.yAxis.padding * l.pix;
        } else {
          l.area[3] += i[_t119].width;
        }
        _a31 += 1;
      } else if (i[_t119].position == "right") {
        if (_e69 > 0) {
          l.area[1] += i[_t119].width + l.yAxis.padding * l.pix;
        } else {
          l.area[1] += i[_t119].width;
        }
        _e69 += 1;
      }
    }
  ...
  if (l.categories && l.categories.length && l.type !== "radar" && l.type !== "gauge" && l.type !== "bar") {
    ...
    var _t120 = calCategoriesData(l.categories, l, n, l.chartData.xAxisData.eachSpacing, s),
      _e71 = _t120.xAxisHeight,
      _a32 = _t120.angle;
    n.xAxisHeight = _e71;
    n._xAxisTextAngle_ = _a32;
    l.area[2] += _e71;
    l.chartData.categoriesData = _t120;
  } else {
    if (l.type === "line" || l.type === "area" || l.type === "scatter" || l.type === "bubble" || l.type === "bar") {
      ...
      var _t121 = calCategoriesData(d, l, n, l.chartData.xAxisData.eachSpacing, s),
        _e72 = _t121.xAxisHeight,
        _a33 = _t121.angle;
      n.xAxisHeight = _e72;
      n._xAxisTextAngle_ = _a33;
      l.area[2] += _e72;
      l.chartData.categoriesData = _t121;
    } else {
  ...
  if (l.enableScroll && l.xAxis.scrollAlign == "right" && l._scrollDistance_ === undefined) {
    var _t122 = 0,
      ...
      _a34 = l.chartData.xAxisData.startX,
      _i19 = l.chartData.xAxisData.endX,
      _r13 = l.chartData.xAxisData.eachSpacing;
    var _o10 = _r13 * (_e73.length - 1);
    var _n6 = _i19 - _a34;
    _t122 = _n6 - _o10;
    h.scrollOption.currentOffset = _t122;
    h.scrollOption.startTouchX = _t122;
    h.scrollOption.distance = 0;
    h.scrollOption.lastMoveTime = 0;
    l._scrollDistance_ = _t122;
  }
...
uCharts.prototype.updateData = function () {
  ...
  var c = t.scrollPosition || "current";
  switch (c) {
    case "current":
    ...
    case "left":
      ...
      break;
    case "right":
      var _t124 = calYAxisData(this.opts.series, this.opts, this.config, this.context),
        e = _t124.yAxisWidth;
      this.config.yAxisWidth = e;
      var a = 0;
      var i = getXAxisPoints(this.opts.categories, this.opts, this.config),
        r = i.xAxisPoints,
        o = i.startX,
        n = i.endX,
        l = i.eachSpacing;
...
uCharts.prototype.zoom = function () {
  ...
  var a = calYAxisData(this.opts.series, this.opts, this.config, this.context),
    i = a.yAxisWidth;
  this.config.yAxisWidth = i;
  var r = 0;
  var o = getXAxisPoints(this.opts.categories, this.opts, this.config),
    h = o.xAxisPoints,
    c = o.startX,
    d = o.endX,
    n = o.eachSpacing;
...
uCharts.prototype.dobuleZoom = function (t) {
  ...
  var i = [getTouches(a[0], this.opts, t), getTouches(a[1], this.opts, t)];
  var c = Math.abs(i[0].x - i[1].x);
  if (!this.scrollOption.moveCount) {
    ...
    var s = this.getCurrentDataIndex(_t125).index;
    var h = this.getCurrentDataIndex(_e75).index;
    var v = Math.abs(s - h);
  ...
  var d = c / this.scrollOption.moveCount;
  var r = (this.opts.width - this.opts.area[1] - this.opts.area[3]) / d;
  r = r <= 2 ? 2 : r;
  r = r >= this.opts.categories.length ? this.opts.categories.length : r;
  this.opts.animation = false;
  this.opts.xAxis.itemCount = r;
  var o = 0;
  var n = getXAxisPoints(this.opts.categories, this.opts, this.config),
    x = n.xAxisPoints,
    f = n.startX,
    p = n.endX,
    l = n.eachSpacing;
  var u = l * this.scrollOption.moveCurrent1;
  var g = p - f;
  var y = g - l * (x.length - 1);
...
uCharts.prototype.getCurrentDataIndex = function (e) {
  ...
  if (a) {
    var t = getTouches(a, this.opts, e);
  ...
  if (this.opts.type === "radar") {
    ...
    if (o > -1) {
      ...
      if (n.length !== 0) {
        var s = n.map(function (t) {
          return {
            text: e.formatter ? e.formatter(t, _this2.opts.categories[o], o, _this2.opts) : t.name + ": " + t.data,
            color: t.color,
            legendShape: _this2.opts.extra.tooltip.legendShape == "auto" ? t.legendShape : _this2.opts.extra.tooltip.legendShape
          };
        });
        var h = {
          x: a.x,
...
uCharts.prototype.scroll = function (t) {
  ...
  var a = Date.now();
  var i = a - this.scrollOption.lastMoveTime;
...
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ 117));
var _wrapNativeSuper2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/wrapNativeSuper */ 118));
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _uniI18n = __webpack_require__(/*! @dcloudio/uni-i18n */ 22);
var _pages = _interopRequireDefault(__webpack_require__(/*! @/pages.json */ 120));
...
var x = "";
try {
  x = (__webpack_require__(/*! uni-stat-config */ 121).default || __webpack_require__(/*! uni-stat-config */ 121)).appid;
} catch (e) {}
var R = {};
function U(e) {
...
var getPrototypeOf = __webpack_require__(/*! ./getPrototypeOf.js */ 117);
var setPrototypeOf = __webpack_require__(/*! ./setPrototypeOf.js */ 16);
var isNativeFunction = __webpack_require__(/*! ./isNativeFunction.js */ 119);
...
/* 120 */
/*!********************************************************************************************!*\
  !*** D:/wechatWorkSpace/uni_pro/ldar_uni/ldar_uni/pages.json?{"type":"origin-pages-json"} ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  "pages": [{
    ...
    "style": {
      "navigationBarTitleText": "LDAR管理平台"
    }
  }],
  "subPackages": [{
    "root": "subpkg",
  ...
  "tabBar": {
    ...
    "list": [{
      ...
      "text": "登录页",
      "iconPath": "static/tab_icons/身份认证.png",
      "selectedIconPath": "static/tab_icons/身份认证.png"
    }, {
      "pagePath": "pages/index/index",
      "text": "首页",
      "iconPath": "static/tab_icons/首页.png",
      "selectedIconPath": "static/tab_icons/首页.png"
    }]
  }
};
exports.default = _default;
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 2)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/wx.js */ 1)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 113)["default"]))
